...
|---|---|---|
| **Top-Left: Z₃ Vacuum Lattice** | 46 colored rays on a dark sphere. Gold thick lines cluster at the "Democratic pole." Cyan lines scatter around (Hybrid family). Red lines lie near the equator. Three dashed axes = flavor coordinates | This is the paper's core mathematical object — the full set of 46 lattice vectors. They are all the "vacuum directions" generated by the Z₃ algebra in 3D. Color tells you which symmetry class (S₃×Z₂ orbit) each vector belongs to |
